...
import com.example.arcwave2026.ui.AppIcon
import com.example.arcwave2026.ui.appIconPainter
        ...
        AnimatedVisibility(visible = arcMenuOpen) {
            Column(
                ...
                ArcSeekBar(
                    ...
                    onScrubStart = { onDraggingChange(true) },
                    onScrub = { ms -> onDragMsChange(ms) },
                    onScrubEnd = { ms ->
                        onDraggingChange(false)
                        onSeekTo(ms)
                    }
